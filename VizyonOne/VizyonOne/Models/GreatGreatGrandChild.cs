...
{
    public class GreatGreatGrandChild
    {
        private const string _nameOfDefaultRecord = "GreatGreatGrandChild";
        private const string _typeOfParentRecord = "GreatGrandChild";
